...
#define IR_SEND_PIN        38
#define TONE_PIN            4
#define APPLICATION_PIN     40
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 6 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 7

#  else // Default as for ATmega328 like on Uno, Nano, Leonardo, Teensy 2.0 etc.                                                                    HIER
#define IR_RECEIVE_PIN      44
#define IR_SEND_PIN        46
#define TONE_PIN            40
#define APPLICATION_PIN     42
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 34 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 36
